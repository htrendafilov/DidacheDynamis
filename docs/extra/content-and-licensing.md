...
| **King James Version (KJV)** | English | CrossWire Dist. License / UK Crown Copyright | ⚠️ GPL Module License | Official module fetched from CrossWire during the build; no KJV text is committed |
