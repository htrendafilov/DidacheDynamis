...
Every shipped work has recorded provenance and redistribution terms, and every work in the table
below is one the application actually serves — the two must not drift apart. The detailed audit and the gate
...
| **TSK Cross-References** | English | CC BY 4.0 | ✅ Permitted with attribution | Treasury of Scripture Knowledge cross-references. CC BY 4.0 requires the attribution, a licence link, and an indication of changes to travel with the data — including inside `content.sqlite` and the container image |
