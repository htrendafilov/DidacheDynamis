...
adapters import WEB USFX and the raw-OSIS IMP generated by `scripts/fetch-kjv.sh` from CrossWire's
checksum-pinned official KJV module. The generated KJV input is ignored by Git and never committed.
